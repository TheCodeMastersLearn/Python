...
class math:
    ...
    #
    # comments
    # This method adds and returns -1 for error.
    ######################
    ...
    #
    # comments
    # This method subtracts and returns -1 for error.
    ######################
    ...
    #
    # comments
    # This method divides and returns -1 for error. Also prints error for zero division.
    ######################
    ...
    #
    # comments
    # This method multiplies and returns -1 for error.
    ######################
    ...
    #######################
    #
    # Function Name: validate_numbers
    # Parameters: num1:float, num2:float
    # return type float
    #
    # comments
    # This method verifies that num1 and num2 are floats or int
    ######################
...
#Input from user and splits and lowers it for easier use.
...
#If all else fails they must have mispelled something.
else:
